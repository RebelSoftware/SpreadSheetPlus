...
"""
GUI entry point for the fcspreadsheet2 addon.
...
FreeCAD loading sequence:
    1. freecad.fcspreadsheet2.__init__ (headless, always runs)
    2. freecad.fcspreadsheet2.init_gui (GUI only)
...
from .workbench import FCSpreadSheet2Workbench
...
FCSpreadSheet2Workbench.Install()
